...
export default function Login({ onLogin }) {
  ...
  if (loading) return (
    <div style={{minHeight:"100vh",background:"#f9fafb",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter','General Sans',sans-serif"}}>
  ...
  return (
    <div style={{minHeight:"100vh",background:"#f9fafb",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,fontFamily:"'Inter','General Sans',sans-serif"}}>
      <style>{`
        @import url('https://api.fontshare.com/v2/css?f[]=general-sans@400,500,600,700&display=swap');
        *{box-sizing:border-box;margin:0;padding:0;}
        @keyframes fadeUp{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}}
        @keyframes spin{from{transform:rotate(0)}to{transform:rotate(360deg)}}
        .login-input{width:100%;background:#fff;border:1.5px solid #e5e7eb;border-radius:12px;padding:12px 16px;color:#0f172a;font-size:14px;outline:none;font-family:'Inter','General Sans',sans-serif;transition:border-color .15s;}
        .login-input:focus{border-color:#1A73E8;}
        .login-btn{width:100%;background:#1A73E8;color:#fff;border:none;border-radius:12px;padding:14px;font-size:15px;font-weight:700;font-family:'Inter','General Sans',sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:background .15s;}
        .login-btn:hover:not(:disabled){background:#174EA6;}
      ...
      <div style={{width:"100%",maxWidth:400,background:"#fff",border:"1px solid #e5e7eb",borderRadius:24,padding:36,boxShadow:"0 12px 32px rgba(15,23,42,0.06)",animation:"fadeUp 0.5s ease"}}>
        ...
        {mode==="forgot"&&(
          <>
            <div style={{textAlign:"center",marginBottom:24}}>
              <div style={{fontFamily:"'Inter','General Sans',sans-serif",fontSize:24,fontWeight:700,color:"#0f172a",marginBottom:6}}>Recuperar senha</div>
        ...
        {mode==="forgot-sent"&&(
          <div style={{textAlign:"center",padding:"8px 0"}}>
            ...
            <div style={{fontFamily:"'Inter','General Sans',sans-serif",fontSize:22,fontWeight:700,color:"#0f172a",marginBottom:8}}>Verifique seu email</div>
