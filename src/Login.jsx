...
export default function Login({ onLogin }) {
  ...
  if (loading) return (
    <div style={{minHeight:"100vh",background:"#f9fafb",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'General Sans',sans-serif"}}>
      <div style={{textAlign:"center"}}>
        <div style={{width:40,height:40,background:"#00C49A",borderRadius:12,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 16px"}}>
  ...
  return (
    <div style={{minHeight:"100vh",background:"#f9fafb",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,fontFamily:"'General Sans',sans-serif"}}>
      <style>{`
      ...
      <div style={{width:"100%",maxWidth:400,background:"#fff",border:"1px solid #e5e7eb",borderRadius:24,padding:36,boxShadow:"0 12px 32px rgba(15,23,42,0.06)",animation:"fadeUp 0.5s ease"}}>
        ...
        {mode==="login"&&(
          <>
            ...
            <form onSubmit={handleLogin} style={{display:"flex",flexDirection:"column",gap:16}}>
              ...
              <div>
                <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:6}}>
                  ...
                  <button type="button" onClick={()=>{setError("");setMode("forgot");setForgotEmail(email);}} style={{background:"none",border:"none",color:"#00C49A",fontSize:12,fontWeight:600,cursor:"pointer",padding:0}}>
                    Esqueci a senha
                  </button>
                </div>
            ...
            <div style={{marginTop:20,textAlign:"center",fontSize:13,color:"#6b7280"}}>
              Não tem conta? <a href="/landing" style={{color:"#00C49A",fontWeight:600,textDecoration:"none"}}>Comece grátis</a>
            </div>
          </>
        )}
        ...
        {mode==="forgot"&&(
          <>
            <div style={{textAlign:"center",marginBottom:24}}>
              <div style={{fontFamily:"'General Sans',sans-serif",fontSize:24,fontWeight:700,color:"#0f172a",marginBottom:6}}>Recuperar senha</div>
        ...
        {mode==="forgot-sent"&&(
          <div style={{textAlign:"center",padding:"8px 0"}}>
            ...
            <div style={{fontFamily:"'General Sans',sans-serif",fontSize:22,fontWeight:700,color:"#0f172a",marginBottom:8}}>Verifique seu email</div>
