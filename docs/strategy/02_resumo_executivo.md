...
URL única por negócio: `startouch.com.br/avaliar?place_id=XXX`
...
URL: `startouch.com.br/ativar?from=web`
...
### 3. Painel do dono (`startouch.com.br/app`)
...
| Email transacional | Resend (domínio startouch.com.br em verificação) |
| APIs externas | Google Places API |
| Deploy | Vercel (auto-deploy via `git push origin main`) |
| Domínio | `startouch.com.br` (principal), `reputazap.com` (redirect 301 — preserva tráfego histórico) |
...
| Item | Status |
|---|---|
| Domínio `startouch.com.br` | ✅ Ativo (principal) |
| Domínio `reputazap.com` | ✅ Redirect 301 pra startouch.com.br |
...
- **Deploy:** startouch.com.br (Vercel auto-deploy via main branch)
