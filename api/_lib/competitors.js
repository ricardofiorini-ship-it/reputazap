...
// Lentes padrão: mesma busca (CEP/região × termo).
// ~2km bate melhor com o que o Google traz pro "termo + CEP"; 5km de comparação.
export const VISIBILITY_LENSES = [
  { key: "regiao",   label: "Na sua região", radius: 2000 },
